...
args is an object, with the following properties and their default value:
  ...
  loop: [Boolean] whether the sprites start over when they reach their very last frame,
...
class MultipleSpritesheet extends createjs.Container {
  constructor(args = {}) {
  ...
  */
  _drawReverse(force) {
    ...
    if (force || now - this.previousTime >= 1000 / this.currFramerate) {
      this.gotoAndStop(this.currFrame, false);
...
module.exports = createjs.promote(MultipleSpritesheet, 'Container');
